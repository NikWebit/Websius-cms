...
/**
 * GZIP-сжатый вывод ресурсов и утилита управления кешем, статической
 * консолидацией ресурсов и кешированием.
 *
...
if (isset($_SERVER['HTTP_IF_NONE_MATCH']) && stripslashes($_SERVER['HTTP_IF_NONE_MATCH']) == $etag && $if_modified_since >= $file_last_modified) {
    $protocol = (isset($_SERVER['SERVER_PROTOCOL'])) ? $_SERVER['SERVER_PROTOCOL'] : 'HTTP/1.1';
