...
switch ($a) {
    ...
    case 'details':
                ...
                if (!empty($info_file['Error'])) {
                    ...
                    if (empty($info_file['Tags'])) {
                        ...
                        foreach ($taggroups as $taggroup) {
                            ...
                            if (cot::$cfg['xtpl_cache']) { // clears cache if exists
        ...
        if ($exists) {
            ...
            $t->assign(array(
                'ADMIN_EXTENSIONS_RIGHTS' => $type == 'module' ? cot_url('admin', "m=rightsbyitem&ic=$code&io=a") : cot_url('admin', "m=rightsbyitem&ic=$type&io=$code"),
