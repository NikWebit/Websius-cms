...
cot::$out['subtitle'] = cot::$L['contact_title'] . ' ' . mb_convert_case($sys['domain'], MB_CASE_TITLE);
$cfg['subtitle'] = $L['meta_desc'];
$cfg['metakeywords'] = $L['meta_keywords'] . ' ' . $sys['domain'];

if (cot::$cfg['plugin']['contact']['noindex']) {
