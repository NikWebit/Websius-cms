...
$L['install_body_message2'] = 'Рекомендуем создать в папке datas/configs/ файл config.php, скопировать в него содержимое файла datas/configs/prototype/proto__config.php и установить на него права CHMOD 666.';
...
$L['install_complete_note'] = 'Удалите install.php и установите на datas/configs/config.php права CHMOD 644. Это необходимо для повышения безопасности вашего сайта.';
...
$L['install_error_config'] = 'Не удаётся создать или отредактировать файл конфигурации. Скопируйте содержимое файла datas/configs/prototype/proto__config.php в datas/configs/config.php. Установите на файл config.php права CHMOD 777.';
...
$L['install_update_config_error'] = 'Невозможно обновить datas/configs/config.php. Пожалуйста, установите CHMOD 664 или 666 на этот файл и попробуйте снова. Если это не помогло, убедитесь, что файл datas/configs/prototype/proto__config.php существует.';
$L['install_update_config_success'] = 'Файл datas/configs/config.php обновлен';
