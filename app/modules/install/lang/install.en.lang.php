...
$L['install_body_message2'] = 'It is recommended to copy datas/configs/prototype/proto__config.php to datas/configs/config.php and set CHMOD 666 on datas/configs/config.php before running this script.';
...
$L['install_complete_note'] = 'You may remove install.php and set CHMOD 644 on datas/configs/config.php now until the next update to improve site security';
...
$L['install_error_config'] = 'Could not create or edit config file. Please save datas/configs/prototype/proto__config.php as datas/configs/config.php and set CHMOD 777 on it';
...
$L['install_update_config_error'] = 'Cannot update datas/configs/config.php. Please set CHMOD 664 or 666 on it and try again. If it does not help, make sure that datas/configs/prototype/proto__config.php exists.';
$L['install_update_config_success'] = 'Successfully updated datas/configs/config.php';
