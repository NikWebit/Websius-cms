...
$L['shield_protect'] = 'Анти-хаммеринг активирован, попробуйте снова через <mark>{$sec} секунд</mark>...<br>После этого промежутка времени вы сможете обновить данную страницу и продолжить.<br>Последнее действие: <strong>&#128296; {$action}</strong>';
